...
class ChineseCalendar {
	...
	static String sCalendarSolarToLundar(int[] intArray) {
		return sCalendarSolarToLundar(intArray[0], intArray[1], intArray[2]);
	}

	static String sCalendarLundarToSolar(int[] intArray) {
		return sCalendarLundarToSolar(intArray[0], intArray[1], intArray[2]);
	}
